...
export const pricingPlans = [
	...
	},
	{
		name: "Basic",
		price: 49,
		priceId: "price_1SCv0kFb2EqqiFBeDjl4G0nE",
		features: ["All Free features", "Some pro tools", "Email support"],
	},
	{
		name: "Unlimited Sass",
		price: 190,
		priceId: "price_1SCv0kFb2EqqiFBeab4Bh7LC",
		features: [
			"All Free + Starter features",
			"Advanced tools",
			"Priority support",
		],
		highlight: true, // premium highlight
	},
];
